  ...
  return (
    <div className="bg-base-200 min-h-screen pt-28 pb-20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Featured Post (Optional Large Highlight) */}
        <div className="mb-12">
          <div className="card lg:card-side bg-base-100 shadow-xl border border-base-300 rounded-[2.5rem] overflow-hidden">
            ...
            <div className="card-body lg:w-1/2 p-10 justify-center">
              <div className="badge badge-primary mb-4">{blogs[0].category}</div>
              ...
              <div className="card-actions">
                <button className="btn btn-primary rounded-xl">Read Article</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.slice(1).concat(blogs[0]).map((post) => (
            <div key={post.id} className="bg-base-100 rounded-[2rem] overflow-hidden border border-base-300 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-8">
                ...
                <button className="flex items-center gap-2 text-sm font-bold hover:gap-4 transition-all text-primary">
        ...
        <div className="mt-20 bg-primary/10 rounded-[3rem] p-12 text-center border border-primary/20">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input type="email" placeholder="Enter your email" className="input input-bordered rounded-2xl flex-grow" />
            <button className="btn btn-primary rounded-2xl px-8 font-bold">Subscribe</button>
          </div>
        </div>
